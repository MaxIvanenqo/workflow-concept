...
MAVEN_SET_VERSION_OPTS="-DremoveSnapshot=true -DprocessParent=true -DprocessAllModules=true -DprocessDependencies=true -DprocessPlugins=false -DgenerateBackupsPoms=false -DgroupId=$MAVEN_GROUP_ID"
...
echo "::set-output name=SERVER_USERNAME::$SERVER_USERNAME"
echo "::set-output name=SERVER_PASSWORD::$SERVER_PASSWORD"